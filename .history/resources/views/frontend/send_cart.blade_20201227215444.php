...
<div id="page-content">
    ...
    <section class="py-3 gry-bg">
        <div class="container">
                            ...
                            <div class="card-body text-center">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <a type="button" data-toggle="modal" data-target="#GuestCheckout"
                                            class="btn btn-styled btn-base-1">{{ translate('Send By Email')}}</a>
                                    </div>
                                    <div class="col-md-4">
            ...
            <a href=""   style="display: none;" class="btn btn-styled btn-base-1">{{ translate('SMS')}}</a>
        </div>
                    ...
                    <form class="form-default" role="form" action="{{ route('sendcartbyemail') }}" method="POST">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-6 text-right">
                                <button type="submit"
                                    class="btn btn-styled btn-base-1 px-4">{{ translate('Send')}}</button>
                            </div>
                        </div>
                    </form>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="p-3">
                    ...
                    <form class="form-default" role="form" action="{{ route('sendcartbywhatsapp') }}" target="_blank" method="POST">
                        @csrf

                        <div class="form-group">
                            <input type="text" name="number" class="form-control h-auto form-control-lg"
                                placeholder="Phone Number With +xx">
                            <input type="hidden" name="url" class="form-control h-auto form-control-lg"
                                value="{{ route('getUserSendCart', $sendorder->token) }}">
                        </div>
                            ...
                            <div class="form-group">
                                 <input type="text" name="name" class="form-control h-auto form-control-lg" placeholder="Patient name">
                                <input type="text" name="email" class="form-control h-auto form-control-lg" placeholder="E-mail">

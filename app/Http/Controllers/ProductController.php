...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        DB::table('product_translation')->insert([
            'Name' => $request->name,
            'Unique' => $product->id,
            'Producer' => $request->name,
            'explained' => $request->description,
            'language' => "en",
        ]);
        ...
        DB::table('product_translation')->insert([
            'Name' => $request->name,
            'Unique' => $product->id,
            'Producer' => $request->input('name_ar'),
            'explained' => $request->input('description_ar'),
            'language' => "ar",
        ]);
    ...
    public function update(Request $request, $id)
    {
      ...
      // dd($id);
        DB::table('product_translation')
            ->where('Unique', $id)->where('language', "en")
            ->update([
                'Name' => $request->name,
                'Unique' => $product->id,
                'Producer' => $request->name,
        ...
        DB::table('product_translation')
            ->where('Unique', $id)->where('language', "ar")
            ->update([
                'Name' => $request->name,
                'Unique' => $product->id,
                'Producer' => $request->name_ar,
                'explained' => $request->description_ar,
                'language' => "ar",
            ]);
        $product->save();

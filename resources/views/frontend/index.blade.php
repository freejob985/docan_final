...
.product-box-2 .overflow-hidden {
    ...
    <section class="home-banner-area mb-4">
            ...
            <div class="row no-gutters position-relative">
                ...
                <div class="col-lg-12 d-none d-lg-block" style="display:none!important;">
        ...
        <section class="mb-4">
            <div class="container">
                <div class="px-2 py-4 p-md-4 bg-white shadow-sm">
                    <div class="section-title-1 clearfix">
                        <h3 class="heading-5 strong-700 mb-0 float-left">
                            <span class="mr-4">Best Affilator</span>
                        </h3>
                    </div>
                    <div class="caorusel-box arrow-round gutters-5">
                             ...
                             <div class="row no-gutters product-box-2 align-items-center">
                                ...
                                @if(count(\App\User::whereHas('affiliate_user')->get()) > 0)



                                @foreach (\App\User::whereHas('affiliate_user')->get() as $user)

                        <div class="col-md-3">
                                <div class="item-con">
                                    <img src="{{ url('public/' . $user->avatar_original ) }}" />
                                     <h5> <a href="{{ route('doctor', $user->id) }}"> {{ $user->name  }} </a></h5>

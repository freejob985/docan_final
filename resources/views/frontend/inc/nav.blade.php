                        ...
                        <li class="dropdown" id="lang-change">
                            ...
                            <a href="" class="dropdown-toggle top-bar-item" data-toggle="dropdown">
                                    @if (Session::get('locale', Config::get('app.locale'))=="ar")
                                                                    <img src="https://5zznly.com/p/2020/12/ptC7H_ar.png" height="11" data-src="https://5zznly.com/p/2020/12/ptC7H_ar.png" class="flag lazyload" alt="{{ \App\Language::where('code', "ar")->first()->name }}" height="11"><span class="language">{{ \App\Language::where('code', "ar")->first()->name }}</span>
   ...
   @else
    ...
    @endif
                                ...
                                @foreach (\App\Language::all() as $key => $language)
                                    @if ($language->code==="ar")
                                       <li class="dropdown-item @if($locale == $language) active @endif">
                                        <a href="#" data-flag="{{ $language->code }}"><img src="https://5zznly.com/p/2020/12/ptC7H_ar.png" data-src="https://5zznly.com/p/2020/12/ptC7H_ar.png" class="flag lazyload" alt="{{ $language->name }}" height="11"><span class="language">{{ $language->name }}</span></a>
                                    </li>
                ...
                @endif
                        ...
                        <li class="dropdown" id="currency-change" style="
    display: none;
">
                            @php
                ...
                <div class="col-5 text-right d-none d-lg-block">
                    <ul class="inline-links">
                        ...
                        <li>
                            <button type="button" class="btn btn-success" data-toggle="modal" data-target="#myModal">{{ translate('Upload Prescription')}}</button>
                        </li>
                        @else
                        <li>
                        ...
                        <li>
                            <a style="color: #fff;"  class="btn btn-success" href="{{ route('affiliate.apply') }}">{{ translate('Be a partner')}}</a>
        ...
        <div class="modal-dialog">
          ...
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title">{{ translate('Upload Prescription')}}</h4>
            </div>
            <div class="modal-body">
                <form method="POST" action="{{ route('uploadprescription') }}" enctype="multipart/form-data">
                    @csrf
                    <input type="file" name="prescription" required="required">

            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-danger" data-dismiss="modal">{{ translate('CLose') }}</button>
              <button type="submit" class="btn btn-success"> {{ translate('Upload') }}</button>
            </div>
        </form>
          </div>

		...
		<form class="form form-horizontal mar-top" action="{{route('products.store')}}" method="POST" enctype="multipart/form-data" id="choice_form">
			...
			<div class="panel">
				...
				<div class="panel-body">
                    ...
                    <div class="form-group">
						<label class="col-lg-2 control-label">Product name is Arabic</label>
						<div class="col-lg-7">
							<input type="text" class="form-control" name="name_ar" placeholder="Product name is Arabic" onchange="update_sku()" required>
						</div>
					</div>
            ...
            <div class="panel">
				<div class="panel-heading bord-btm">
					<h3 class="panel-title">Product description Arabic</h3>
				</div>
				<div class="panel-body">
					<div class="form-group">
						<label class="col-lg-2 control-label">Product description Arabic</label>
						<div class="col-lg-9">
							<textarea class="editor" name="description_ar"></textarea>
						</div>
					</div>
				</div>
            </div>

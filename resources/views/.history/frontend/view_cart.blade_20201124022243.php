                        ...
                        <div class="row align-items-center pt-4">
                            ...
                            <div class="col-md-9">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                    @if (Auth::user()->has('affiliate_user'))

                                    <a class="btn btn-styled btn-base-2 btn-disable"> <i style="font-size: 20px;" class="fa fa-truck"></i> {{ translate('Send To User')}}</a>
                                   ...
                                   <div class="col-md-6">
                                     ...
                                     <?php
                                   $affiliate_users = DB::table('affiliate_users')->where('user_id', Auth::user()->id)->exists();
                                   dd( $affiliate_users);

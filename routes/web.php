...
Route::any('pdf', function () {
     ...
     //   Excel::mergeCells('A2:B2');
             ...
             return    Excel::download(new avd, 'avd.xlsx');



});

Route::get('data-pdf', 'AffiliateController@makepdf')->name('data-pdf');
Route::get('makeadminpdf/{id}', 'AffiliateController@makeadminpdf')->name('makeadminpdf');

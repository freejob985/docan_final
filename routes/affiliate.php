...
Route::get('/affiliate/myaffilateorders/{id?}', 'AffiliateController@myaffilateorders_admin')->name('affiliate.myaffilateorders_admin');
...
Route::get('/data-excel', 'AffiliateController@data_excel')->name('affiliate.data-excel');
